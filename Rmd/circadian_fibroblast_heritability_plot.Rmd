...
h2_amplitude = h2_strainanova(anova_amplitude_df["Strain","Mean Sq"],
                              anova_amplitude_df["Residuals","Mean Sq"],
                              mean_n)
h2_amplitude
```
...
```{r sessionInfo}
circadian_fibroblast_sessionInfo = sessionInfo()
circadian_fibroblast_sessionInfo
saveRDS(circadian_fibroblast_sessionInfo, paste(script_root_dir, "./output/circadian_fibroblast_sessionInfo_",current_date,".RDS", sep = ""), compress="xz")
```
